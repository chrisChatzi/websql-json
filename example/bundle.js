    ...
    localStorage.prototype = {
    	...
    	//TRANSACTION - fill data, on return make transaction
	    	transaction : function(type, data, callback){
    			...
    			this.callback = callback;
    			//check
    			if(!checkObj) checkObj = new checkClass(type, data, callback);
    			if(checkObj.checkTransaction()) return;
    			//
	    	...
	    	makeTransaction : function(type, data, callback, returnFunction){
		    	...
		    	switch(type){
		    		...
		    		case "update":
						...
						if(Object.keys(data.data.where).length === 0) whereConditions = '';
						else{
		    		...
		    		break;
		    		case "delete":
		    			if(Object.keys(data.data).length === 0) this.conditions = '';
		    			else{
...
},{"./websqlChecks":5,"./websqlTransaction":8}],7:[function(require,module,exports){
(function(){
    'use strict';
...
},{"./websqlClass":6}],8:[function(require,module,exports){
(function(){
    'use strict';
    	...
    	doTransaction : function(){
    		...
    		if(this.queryType == "insert"){
	    		...
	    		this.tx.executeSql(
	    			...
	    			this.values,
	    			function (tx, result){
	    				if(self.successMsg) self.callbackFunction(true, self.successMsg);
	    				else self.callbackFunction(true, result);
		            },
		            function (error){
		            	self.callbackFunction(false, self.failMsg);
		            }
